...
func (m *ConfirmEmailVerificationRequest) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *ConfirmEmailVerificationRequest) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
...
func (m *ConfirmPasswordResetRequest) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *ConfirmPasswordResetRequest) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
